...
import com.zhao.mianshizhao.model.dto.questionBank.QuestionBankAddRequest;
import com.zhao.mianshizhao.model.dto.questionBank.QuestionBankEditRequest;
import com.zhao.mianshizhao.model.dto.questionBank.QuestionBankQueryRequest;
import com.zhao.mianshizhao.model.dto.questionBank.QuestionBankUpdateRequest;
...
import com.zhao.mianshizhao.model.vo.QuestionBankVO;
...
public class QuestionBankController {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ...
        Boolean isNeedQueryQuestionList = questionBankQueryRequest.getIsNeedQueryQuestionList();
        //是否要关联查询题库下的题目列表
        if (isNeedQueryQuestionList){
            QuestionQueryRequest questionQueryRequest = new QuestionQueryRequest();
            questionQueryRequest.setQuestionBankId(questionBankId);
            Page<Question> questionPage = questionService.getQuestionByPage(questionQueryRequest);
